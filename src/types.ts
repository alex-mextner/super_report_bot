...
/**
 * @deprecated Use FSM context from src/fsm/context.ts instead.
 * This interface is kept for backwards compatibility with the adapter layer.
 * TODO: Migrate bot/index.ts handlers to use FSM directly, then remove this.
 */
